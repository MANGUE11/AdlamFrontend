...
const ContactForm = () => {
  // 1. Récupération des données de traduction
  const { translations, selectedLanguage, textDirection } = useLanguage()
  // Accès direct à l'objet 'contactForm' de la langue sélectionnée
      ...
      <div className='container mx-auto px-4 max-w-5xl'>
        <div className='flex flex-col md:flex-row bg-white rounded-3xl shadow-lg overflow-hidden'>
          ...
          <div className='flex-1 bg-[#2c3159] text-white p-8 md:p-12 flex flex-col justify-between rounded-l-3xl'>
            {/* Appliquer la direction au bloc de texte complet */}
            ...
            {/* Les icônes restent LTR pour le placement standard */}
            ...
            <form>
              ...
              <div className='mb-6'>
                ...
                <input
                  ...
                  dir={textDirection} // Direction du texte d'entrée
                />
              </div>
              ...
              <div className='mb-6'>
                ...
                <input
                  ...
                  name='tel'
                  className='w-full px-4 py-3 border border-gray-300 rounded-full focus:ring-2 focus:ring-[#2c3159] focus:border-transparent transition duration-300'
                  dir='ltr' // IMPORTANT : les numéros doivent être LTR
                />
              </div>
              ...
              <div className='mb-6'>
                ...
                <input
                  ...
                  name='email'
                  className='w-full px-4 py-3 border border-gray-300 rounded-full focus:ring-2 focus:ring-[#2c3159] focus:border-transparent transition duration-300'
                  dir='ltr' // IMPORTANT : les adresses email doivent être LTR
                />
              </div>
